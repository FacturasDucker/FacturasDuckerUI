export const regimenFiscal = [
    ...
    { "id": "609", "descripcion": "Consolidación" },
    ...
    { "id": "628", "descripcion": "Hidrocarburos" },
    { "id": "629", "descripcion": "De los Regímenes Fiscales Preferentes y de las Empresas Multinacionales" },
    { "id": "630", "descripcion": "Enajenación de acciones en bolsa de valores" }
  ];